...
const About = () => {
  return (
    ...
    <div className="my-auto pt-[4vw] w-7/12 mx-auto text-gray-700 scroll-none snap-none max-[800px]:w-11/12 max-[800px]:pt-12">
      <h1 className="text-3xl my-2 mt-20 font-semibold border-b-2 pb-2 text-black max-[800px]:text-2xl">About Us</h1>
      ...
      <h1 className="text-3xl my-2 mt-20 font-semibold border-b-2 pb-2 text-black max-[800px]:text-2xl">Our Mission</h1>
      <p className="max-[800px]:text-sm">
      ...
      <h1 className="text-3xl my-2 mt-20 font-semibold border-b-2 pb-2 text-black max-[800px]:text-2xl">What We Offer</h1>
      ...
      <h1 className="text-3xl my-2 mt-20 font-semibold border-b-2 pb-2 text-black max-[800px]:text-2xl">Our Commitment</h1>
      <p className="max-[800px]:text-sm">
