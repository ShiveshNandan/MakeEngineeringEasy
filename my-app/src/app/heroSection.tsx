...
import doorDark from "../public/DOOR_dark.png"
...
const HeroSection = () => {
  ...
  // console.log("use " ,useTheme().theme)
  ...
  return (
    <>
      ...
      <Image src={plane2} height={1} width={100000} alt='' className='w-[20vw] absolute mt-[-55vh] dark:invert '/>
      ...
      <h1 className='uppercase m-auto text-[4vw] tracking-[0.8px] w-7/12 text-[#333333] leading-[5.5vw] dark:text-[#fffaf5] '>
        unlock the <span className='inline-block'><Image src={'/DOOR.png'} height={1} width={100000} alt='' className='w-[12vw] dark:invert-[0.1]'/></span> to <span className='inline-block'><Image src={sit} width={10000} height={1800} alt='' className=' w-[4.5vw] absolute mt-[-4vw] ml-[-0.7vw] '/></span> effortless <span className='px-[1.5vw] ml-[1vw] border-[#3b82f6] text-[#3b82f6] border-[3px] border-dashed rounded-2xl inline-block'>learning</span>
        </h1>
      ...
      <div style={{fontFamily : 'YourFont'}} className="flex flex-col text-center bg-[#fff3e8] rounded-[70px] justify-center dark:bg-[#242424]">
        <div className="flex flex-col w-10/12 border-4 border-b-0 justify-center border-dashed border-[#c1b9b2] rounded-[70px] my-20 mt-40 mx-auto dark:border-[#6f6a65] dark: drop">
